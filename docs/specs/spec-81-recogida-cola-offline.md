...
**Archivos:** `lib/offline/photos.ts`, `photos.test.ts`, `lib/db.ts` (tipo `manifest_photo`), `lib/pickup/offlineQueueSender.ts` (despacho a `sendManifestPhoto`)
