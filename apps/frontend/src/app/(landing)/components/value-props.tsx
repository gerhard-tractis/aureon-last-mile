...
export function ValueProps() {
  return (
    <section id="problema" aria-label="El problema" className="relative bg-stone-900 pt-20 pb-24 scroll-mt-16">
      {/* Section gradient */}
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {pains.map((pain, i) => (
            <ScrollReveal key={pain.title} delay={i * 100}>
              <div className="border border-stone-800 hover:border-red-500/35 hover:-translate-y-0.5 bg-stone-950/50 rounded-xl p-7 transition-all duration-200 h-full">
