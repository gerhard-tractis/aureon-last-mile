  ...
  return (
    <section className="relative py-24 overflow-hidden bg-stone-950">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 100%, rgba(230,193,92,0.06) 0%, transparent 60%)',
        }}
      />
        ...
        <ScrollReveal>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="px-8 py-3.5 bg-amber-500 text-stone-950 font-semibold rounded-md hover:bg-amber-400 hover:shadow-[0_0_24px_rgba(230,193,92,0.35)] transition-all text-sm"
            >
              Agenda una llamada →
            </a>
            <a
              href="mailto:gerhard@tractis.ai"
              className="px-8 py-3.5 border border-stone-700 text-stone-300 font-medium rounded-md hover:border-stone-500 hover:text-stone-100 transition-all text-sm"
            >
              Escríbenos directo
            </a>
          </div>
