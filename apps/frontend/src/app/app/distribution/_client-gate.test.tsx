...
describe('DistributionClientGate (RBAC)', () => {
  beforeEach(() => {
    mockPush.mockClear();
  });
  ...
  it('renders children when user has distribution permission', () => {
    ...
    render(<DistributionClientGate><div>Distribution Content</div></DistributionClientGate>);
  ...
  it('allows admin users with distribution permission', () => {
    ...
    render(<DistributionClientGate><div>Admin Distribution</div></DistributionClientGate>);
