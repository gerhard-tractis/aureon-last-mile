    ...
    enRuta: [
      {
        ...
        status: 'in_transit', comunas: ['Puente Alto'], paradasTotal: 24, paradasCompletadas: 13,
...
describe('DispatchEnRutaTab', () => {
  ...
  it('renders the header count line from real route/paradas totals', () => {
    ...
    render(<DispatchEnRutaTab operatorId="op-1" />);
    // 1 on-road route, 24 paradas (from its own planned_stops) — no
    // fabricated "cierre estimado" or "DT SINCRONIZADO" figure anywhere.
