    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "success-chip":      "var(--color-status-success-chip)",
          "success-chip-fg":   "var(--color-status-success-chip-fg)",
          "warning-chip":      "var(--color-status-warning-chip)",
          "warning-chip-fg":   "var(--color-status-warning-chip-fg)",
          "error-chip":      "var(--color-status-error-chip)",
          "error-chip-fg":   "var(--color-status-error-chip-fg)",
          "info-chip":      "var(--color-status-info-chip)",
          "info-chip-fg":   "var(--color-status-info-chip-fg)",
